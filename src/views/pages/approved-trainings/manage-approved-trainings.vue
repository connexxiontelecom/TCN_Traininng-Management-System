...
import ApprovedTrainings from "./approved-training-table";
...
export default {
  page: {
    title: " Approved Trainings",
    meta: [{ name: "description", content: appConfig.description }]
  },
  components: { Layout, PageHeader,ApprovedTrainings,Multiselect,ckeditor: CKEditor.component},
  data() {
    return {
      title: "Approved Trainings",
      items: [
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <ApprovedTrainings :schedules="schedules" @onSelectedSchedule="onSelectedSchedule" />
            <div class="row">
...
<!--                <p class="mt-3">
                  <b-button size="sm" variant="primary">Submit for Nomination</b-button>
                </p>-->
              </div>
